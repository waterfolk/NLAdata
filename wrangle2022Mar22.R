...
uidsiteidkey<-merge(nla2012_wide_siteinfo_08232016 %>% select(uid,site_id),stubborndf %>% select(uid),by="uid")
...
daterr1$var<-paste(daterr1$var," (",daterr1$units,")",sep="")
#daterr1$unit<-"mg/L"
daterr<-daterr1
