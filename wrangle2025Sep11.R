...
# additional names to add 2025-09-11
# perim_km
# wsareasqkm
...
# handle non-detects in algal toxin data 
nla22_algaltoxins$result[which(nla22_algaltoxins$qa_flag=="ND")]<-0.5*nla22_algaltoxins$mdl[which(nla22_algaltoxins$qa_flag=="ND")]
nla_2017_algal_toxin_data$result[which(nla_2017_algal_toxin_data$nars_flag=="ND")]<-0.5*nla_2017_algal_toxin_data$mdl[which(nla_2017_algal_toxin_data$nars_flag=="ND")]
...
############
# add missing watershed areas

#objs <- ls()
#objs_land <- grep("land", objs, value = TRUE)
